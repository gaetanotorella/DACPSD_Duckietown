...
// std::cout<<"[L] intervallo "<<enc_l.intervallo<<" secondi"<<std::endl;
// std::cout<<"[L] differenza "<<enc_l.diff<<std::endl;
// std::cout<<"[L] velocita' "<<enc_l.velocity<<" giri/sec"<<std::endl;
// std::cout<<"          "<<enc_l.velocity*60<<" giri/min"<<std::endl;
// std::cout<<"          "<<enc_l.velocity*(2*M_PI*raggio)<<" m/sec"<<std::endl;
// std::cout<<"          "<<enc_l.velocity*(2*M_PI)<<" rad/sec"<<std::endl;
...
// std::cout<<"[R] intervallo "<<enc_r.intervallo<<" secondi"<<std::endl;
// std::cout<<"[R] differenza "<<enc_r.diff<<std::endl;
// std::cout<<"[R] velocita' "<<enc_r.velocity<<" giri/sec"<<std::endl;
// std::cout<<"          "<<enc_r.velocity*60<<" giri/min"<<std::endl;
// std::cout<<"          "<<enc_r.velocity*(2*M_PI*raggio)<<" m/sec"<<std::endl;
// std::cout<<"          "<<enc_r.velocity*(2*M_PI)<<" rad/sec"<<std::endl;
...
{ 	
	...
	ros::Publisher pub_left 	= nodeHandle.advertise<std_msgs::Float64>("/"+ macchina +"/DUCKS/left_vel", 1);
	ros::Publisher pub_right 	= nodeHandle.advertise<std_msgs::Float64>("/"+ macchina +"/DUCKS/right_vel", 1);
	ros::Publisher pub_v 		= nodeHandle.advertise<std_msgs::Float64>("/"+ macchina +"/DUCKS/v_velocity", 1);
	ros::Publisher pub_omega 	= nodeHandle.advertise<std_msgs::Float64>("/"+ macchina +"/DUCKS/omega_velocity", 1);
